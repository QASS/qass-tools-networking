import qass.tools.networking.analyzer_ssh as SSH

##### Example 1 ########
""" Simple example for examine all supported hardware information and store them as local JSON File."""
with SSH.SSHConnector("network_ip", ssh_password="ssh_password") as terminal:
...
with SSH.SSHConnector("network_ip", ssh_password="ssh_password") as terminal:
    ...
    for device in device_paths:
        required_information = terminal.get_harddrive_information(device, attributes=['SATA_version', 'size'])
